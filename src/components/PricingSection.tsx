...
const plans = [
  {
    ...
    price: "$9",
    period: "/ month",
    tagline: "Low-friction entry for hobbyist pilots",
    tier: "pilot" as const,
    features: [
      "3 projects / month",
  ...
  },
  {
    ...
    price: "$49",
    period: "/ month",
    tagline: "For professional pilots & survey crews",
    valueProp: "Priority queue · Full export history · 10× faster",
  ...
  },
  {
    ...
    price: "$199",
    period: "/ month",
    tagline: "For agencies & multi-pilot teams",
    valueProp: "Client folders · White-label reports · Team seats",
