...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      forum_post_edits: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "forum_post_edits_thread_id_fkey"
            columns: ["thread_id"]
            isOneToOne: false
    ...
    Functions: {
      ...
      forum_increment_view: { Args: { _thread_id: string }; Returns: undefined }
      ...
      is_forum_banned: { Args: { _user_id: string }; Returns: boolean }
      is_org_manager: {
