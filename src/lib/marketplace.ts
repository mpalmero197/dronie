...
export const DELIVERABLE_OPTIONS = [
  ...
  { id: "thermal", label: "Thermal / Infrared Imagery" },
  { id: "multispectral", label: "Multispectral / NDVI" },
  { id: "mesh", label: "3D Textured Mesh" },
  { id: "cad", label: "CAD / DWG / DXF Export" },
  { id: "bim", label: "BIM-Ready Model (IFC / RVT)" },
  { id: "gis", label: "GIS Layers (SHP / GeoJSON)" },
  { id: "topo", label: "Topographic Survey" },
  { id: "cutfill", label: "Cut & Fill / Stockpile Volumes" },
  { id: "progress", label: "Construction Progress Report" },
  { id: "asbuilt", label: "As-Built Documentation" },
  { id: "roof", label: "Roof / Facade Inspection" },
  { id: "tower", label: "Tower / Antenna Inspection" },
  { id: "solar", label: "Solar Panel Inspection" },
  { id: "powerline", label: "Power Line / Utility Inspection" },
  { id: "marketing", label: "Marketing Photo / Video Package" },
  { id: "fpv", label: "FPV / Cinematic Footage" },
  { id: "mapping_kml", label: "KML / KMZ Flight Data" },
  { id: "raw", label: "Raw Imagery (RAW / DNG)" },
];
